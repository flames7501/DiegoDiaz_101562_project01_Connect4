...
class turn:
    ...
    def getColumns(win, i, a, b, c, d, e, f, g, columns):
        turnend = False
    ...
    while (k.getValue() < 42):
        for i in colors:
            ...
            if(winner == 2):
                ...
                a, b, c, d, e, f, g, columns = turn.getColumns(win, i, a, b, c, d, e, f, g, columns)
                #Check if a win happened
                winner = check_win(columns, k.getValue())
                #Increase turn count
                k.setValue(k.getValue() + 1)
                #Check for winner, if a winn happened
                k.setValue(check_winner(k.getValue(), winner))       
